...
- AI：有新增消息催化，代表消息是“CBRE Group (CBRE) Dropped Amid Concerns on Potential AI Disintermediation”，开盘重点看强度和持续性。
- 半导体：暂未看到明确新增催化，更多看资金承接和个股公告。
- 铜和有色金属：暂未看到明确新增催化，更多看资金承接和个股公告。
- 液冷和数据中心：有新增消息催化，代表消息是“HIVE Digital closes $130M exchangeable notes offering to fund AI, data center expansion”，开盘重点看强度和持续性。
...
纳斯达克100期货、富时A50期货、铝 走弱相关方向，以及开盘快速冲高但量能不足的个股。

### 5. 今日关注方向

AI、液冷和数据中心、道指期货、黄金、铜
